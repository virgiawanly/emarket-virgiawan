                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend">
                                    <button type="button" class="btn btn-primary px-3" data-toggle="modal" data-target="#modalPilihBarang">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" disabled id="totalHarga" placeholder="Rp " class="form-control" />
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <input type="text" class="form-control cari-pelanggan" name="kode_pelanggan" id="cariPelanggan" />
                                        <div class="input-group-prepend">
                                            <button type="button" class="btn btn-primary px-3" data-toggle="modal" data-target="#modalPilihPelanggan">
                                                <i class="fas fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" id="totalBayar" name="total_diterima" placeholder="Rp " class="form-control" min="0" />
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" disabled id="totalKembali" placeholder="Rp " class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $("#tablePilihBarang").on("click", ".button-pilih-barang", function() {
        ...
        if (arr_barang_id.some((id) => barang_id == id)) {
            ...
            let inputDiskon = `<input type="number" class="form-control" name="diskon[]" value="${diskon}" min="0" max="100">`;
            let displaySubtotal = `Rp <span class="display-subtotal">${formatter.format(harga_diskon)}</span>`;
            let buttonHapus = `<button type="button" class="button-hapus-barang btn btn-sm btn-danger" title="Hapus Barang"><i class="fas fa-trash"></i></button>`;
